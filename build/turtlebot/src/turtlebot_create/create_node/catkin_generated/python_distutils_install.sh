...
echo_and_run cd "/home/azra/catkin_ws_kr/src/turtlebot/src/turtlebot_create/create_node"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/azra/catkin_ws_kr/src/turtlebot/src/turtlebot_create/create_node/setup.py" \
    build --build-base "/home/azra/catkin_ws_kr/build/turtlebot/src/turtlebot_create/create_node" \
    install \
    $DESTDIR_ARG \
